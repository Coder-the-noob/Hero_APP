  ...
  return (
    <footer className="bg-[#001931] text-white p-10">
      <div className="w-full flex flex-col sm:flex-row justify-between items-center sm:items-start">
        <a className="flex items-center gap-2 mb-6 sm:mb-0">
        ...
        <nav className="text-center sm:text-right">
          <h6 className="footer-title mb-2 text-gray-300 font-semibold">
            Social Links
          </h6>
          <div className="flex justify-center sm:justify-end gap-4">
            <a className="hover:text-[#9F62F2] transition-colors duration-300">
              <svg
