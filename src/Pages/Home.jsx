    ...
    <div className="w-full flex flex-col items-center justify-center">
      <section className="w-full text-center px-4 bg-white">
        <h2 className="text-3xl md:text-5xl font-bold mb-4">
          We Build <br /> <span className="font-bold bg-[linear-gradient(125.07deg,rgba(99,46,227,1),rgba(159,98,242,1))] bg-clip-text text-transparent">Productive</span> Apps
        </h2>
        <p className="text-gray-600 max-w-2xl mx-auto mb-8">
          At <span className="font-semibold">HERO.IO</span>, we craft innovative apps designed to make everyday life simpler,
      ...
      <div className="mt-10 flex flex-col items-center justify-center">
        <Link
          to="/allapps"
          className="text-white bg-[linear-gradient(125.07deg,rgba(99,46,227,1),rgba(159,98,242,1)_100%)] hover:opacity-90 font-semibold px-4 py-2 rounded-lg text-lg"
        >
          Show All
        </Link>
      </div>
